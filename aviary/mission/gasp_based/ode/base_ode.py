...
class BaseODE(om.Group):
    ...
    #         promotes_outputs = [Dynamic.Mission.EQUIVALENT_AIRSPEED, Dynamic.Mission.MACH]
    #     elif input_speed_type is SpeedType.EAS:
    #         promotes_inputs = [Dynamic.Mission.EQUIVALENT_AIRSPEED]
    ...
    #         promotes_outputs = [Dynamic.Mission.EQUIVALENT_AIRSPEED, Dynamic.Mission.VELOCITY]

    #     self.add_subsystem(
    #         "fc",
    #         FlightConditions(num_nodes=nn, input_speed_type=input_speed_type),
    #         promotes_inputs=[Dynamic.Mission.DENSITY, Dynamic.Mission.SPEED_OF_SOUND] + promotes_inputs,
