...
class GlideTestCase(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        expected_values = {
            (Mission.Landing.INITIAL_VELOCITY, 'kn'): 142.84060552,
            (Mission.Landing.STALL_VELOCITY, 'kn'): 109.87738886,
            ('TAS_touchdown', 'kn'): 126.35899719,
            ('density_ratio', 'unitless'): 1.0,
            ('wing_loading_land', 'lbf/ft**2'): 120.7124813,
            ('theta', 'deg'): 3.56713287,
            ('glide_distance', 'ft'): 802.0689817,
            ('tr_distance', 'ft'): 166.59726731,
            ('delay_distance', 'ft'): 213.26996099,
...
class GroundRollTestCase(unittest.TestCase):
    ...
    def test_case_1(self):
        ...
        expected_values = {
            'ground_roll_distance': 2406.37846399,
            Mission.Landing.GROUND_DISTANCE: 3588.37846399,
            'average_acceleration': 0.2930877,
        }
    ...
    def test_case_alt_gravity(self):
        self.prob.model_options['*'] = {Mission.GRAVITY: (30, 'ft/s**2')}
        ...
        expected_values = {
            'ground_roll_distance': 2411.17937459,
            Mission.Landing.GROUND_DISTANCE: 3593.17937459,
            'average_acceleration': 0.31395444,
        }
