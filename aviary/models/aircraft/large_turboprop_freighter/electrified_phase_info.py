...
energy_phase_info = {
    ...
    'climb': {
        ...
        'user_options': {
            ...
            'order': 3,
            'mach_optimize': True,
            'mach_initial': (0.17, 'unitless'),
            'mach_bounds': ((0.17, 0.478), 'unitless'),
            'altitude_optimize': True,
            'altitude_initial': (100.0, 'ft'),
            'altitude_bounds': ((100.0, 22_000.0), 'ft'),
            'no_descent': True,
            'mass_ref': (154000, 'lbm'),
...
two_dof_phase_info = {
    ...
    'rotation': {
        'user_options': {
            ...
            'angle_of_attack_bounds': ((0.0, 20.0), 'deg'),
            'angle_of_attack_ref': (10.0, 'deg'),
            'angle_of_attack_defect_ref': (10.0, 'deg'),
    ...
    'desc2': {
        'user_options': {
            ...
            'altitude_bounds': ((1000.0, 10_000.0), 'ft'),
            'altitude_ref': (10.0e3, 'ft'),
