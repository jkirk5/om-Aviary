...
class DesignMetrics(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        weight = inputs[Aircraft.Design.GROSS_MASS] * GRAV_ENGLISH_LBM
    ...
    def compute_partials(self, inputs, J):
        thrust = inputs[Aircraft.Propulsion.TOTAL_SCALED_SLS_THRUST]
        mass = inputs[Aircraft.Design.GROSS_MASS]
        area = inputs[Aircraft.Wing.AREA]
        ...
        J[Aircraft.Design.THRUST_TO_WEIGHT_RATIO, Aircraft.Design.GROSS_MASS] = -thrust / (
            mass**2 * GRAV_ENGLISH_LBM
        )

        J[Aircraft.Design.WING_LOADING, Aircraft.Design.GROSS_MASS] = GRAV_ENGLISH_LBM / area
